...
function ProjectCard({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (
        registered &&
        (window as any).WebGLSceneInstance &&
    ...
    <>
      <a href={`${p.link}`}>
        <div
          ref={containerRef}
          onMouseEnter={() => {
            (window as any).WebGLSceneInstance?.setHoverItem(
              containerRef.current,
              true,
            );
          }}
...
export default function ZoneD() {
  const projects: Project[] = [
    {
      id: "01",
      title: "LUMINA_ARCHITECTURE",
      tags: ["THREEJS", "HTML", "TAILWIND", "TYPESCRIPT", "WEBGL", "NEXTJS"],
      link: "https://lumina-architechture.vercel.app",
    },
    {
      id: "02",
      title: "SUBURBIA_SKATE_SHOP",
      tags: [
        "THREEJS",
        "HTML",
        "TAILWIND",
      ...
      link: "https://suburbia-skate-nine.vercel.app/",
    },
    {
      id: "03",
      title: "CANON",
      tags: ["VITEJS", "HTML", "TAILWIND", "TYPESCRIPT", "THREEJS", "REACT"],
      link: "https://camera-landingpage.vercel.app",
    },
    {
      id: "04",
      title: "CRIPTO_WEBSITE",
      tags: ["VITEJS", "HTML", "TAILWIND", "TYPESCRIPT", "THREEJS"],
      link: "https://crypto-website-eight-chi.vercel.app",
    },
    {
      id: "05",
      title: "CARE_PLUS",
      ...
      link: "https://patient-management-system-e29m-three.vercel.app",
    },
    {
      id: "06",
      title: "NIKE",
      tags: ["HTML", "TAILWIND", "JAVASCRIPT"],
      link: "https://nike-landing-livid.vercel.app",
    },
  ];
  ...
  return (
    <section
      id="projects"
      className="relative w-full min-h-screen pt-[58px] bg-void flex flex-col border-t border-variant-border"
    >
      {/* Grid of Projects */}
      ...
      <div className="w-full h-[32px] border-t border-variant-border bg-void flex items-center justify-between px-[20px] font-mono text-[11px] text-tertiary shrink-0 opacity-80">
        <span className="tracking-[1px] uppercase">
          ● SYSTEM_STATUS: NOMINAL // CORE_TEMP: 3C // NODE: PORT_8080
        </span>
        <span className="tracking-[1px] uppercase text-on-dark-dim hidden md:block">
          _GIT _X_COM _OS_INTEL
        </span>
      </div>
    </section>
  );
